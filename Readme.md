...
To get the equivalent as a Curl command, use `:RestclientCurl` , which will put it in the unnamed register, or any register, by using `"<reg of your choosing>:RestclientCurl<cr>` in normal mode, or by using `:RestclientCurl <reg><cr>`.
